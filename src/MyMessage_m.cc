...
void MyMessage_Base::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->mHeader);
    doParsimPacking(b,this->mPayload);
    doParsimPacking(b,this->mTrailer);
...
void MyMessage_Base::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->mHeader);
    doParsimUnpacking(b,this->mPayload);
    doParsimUnpacking(b,this->mTrailer);
...
const char * MyMessage_Base::getMPayload() const
{
    return this->mPayload.c_str();
}

void MyMessage_Base::setMPayload(const char * mPayload)
{
...
void MyMessage_Base::setMType(int mType)
{
    this->mType = mType;
}
...
int MyMessageDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='m' && strcmp(fieldName, "mHeader")==0) return base+0;
    if (fieldName[0]=='m' && strcmp(fieldName, "mPayload")==0) return base+1;
    if (fieldName[0]=='m' && strcmp(fieldName, "mTrailer")==0) return base+2;
    if (fieldName[0]=='m' && strcmp(fieldName, "mType")==0) return base+3;
